            ...
            <div className="flex flex-wrap -mx-4 lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="text-base font-semibold text-primary inline border-b-2 border-[#94A9FB]">
                    Contact Us
                  </span>
                  <h2 className=" text-[26px] font-bold uppercase text-dark sm:text-[40px] lg:text-[30px]">
                   # GET IN TOUCH WITH US
                  </h2>
                  <p className="text-base leading-relaxed mb-9 text-body-color">
                  To contact us, please fill out the form on our website or email us at 
                  </p>
